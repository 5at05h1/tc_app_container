...
export default class MessageText extends React.Component {
    ...
    render() {
        ...
        if (!this.props.currentMessage.user.html_flg && (this.props.currentMessage.user.title !== '入居申込書' && this.props.currentMessage.user.status !== 'その他')) {
          return (<View style={[
          ...
          let source = this.props.currentMessage.text.split('”').join('"');
