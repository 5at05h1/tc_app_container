...
export default function Setting(props) {
  ...
  const [open_setting_list1_staff, setOpen_setting_list1_staff] =
    useState(false);

  const [setting_list2, setSetting_list2] = useState(false);
  const [setting_list2_staff, setSetting_list2_staff] = useState("");
  const [open_setting_list2_staff, setOpen_setting_list2_staff] =
    useState(false);

  const [setting_list3, setSetting_list3] = useState(false);

  const [top_staff_list, setTop_staff_list] = useState(
    route.params.top_staff_list
  );
  ...
  const [open_setting_list6_select, setOpen_setting_list6_select] =
    useState(false);
  const [setting_list6_staff, setSetting_list6_staff] = useState("");
  const [open_setting_list6_staff, setOpen_setting_list6_staff] =
    useState(false);

  const [setting_list6, setSetting_list6] = useState(false);

  const [setting_list7, setSetting_list7] = useState(false);
  const [setting_list7_mail, setSetting_list7_mail] = useState(
    route.params.setting_list7_mail
  );
  ...
  useEffect(() => {
    ...
    if (setting_list) {
      ...
      if (
        setting_list.split(",").includes("1") ||
        setting_list.split(",").includes("1_a")
      ) {
        setSetting_list1("1");
      }
      ...
      if (
        setting_list.split(",").includes("2") ||
        setting_list.split(",").includes("2_a")
      ) {
        setSetting_list2("1");
      }
      ...
      if (
        setting_list.split(",").includes("6_2") ||
        setting_list.split(",").includes("6_2_a")
      ) {
        setSetting_list6_select("2");
        setting6_flg = "1";
      }
      if (
        setting_list.split(",").includes("6_1") ||
        setting_list.split(",").includes("6_1_a")
      ) {
        setSetting_list6_select("1");
        setting6_flg = "1";
      }
      if (
        setting_list.split(",").includes("6") ||
        setting_list.split(",").includes("6_a")
      ) {
  ...
  if (typeof profile !== "undefined") {
    ...
    if (
      typeof profile.profile_tag !== "undefined" &&
    ...
    if (
      typeof profile.staff_photo1 !== "undefined" &&
      profile.staff_photo1 != null &&
      profile.staff_photo1 != ""
    ) {
      var photo_1 =
        "https://www.total-cloud.net/img/staff_img/" + profile.staff_photo1;
      // 削除ボタン表示
    ...
    if (
      typeof profile.staff_photo2 !== "undefined" &&
      profile.staff_photo2 != null &&
      profile.staff_photo2 != ""
    ) {
      var photo_2 =
        "https://www.total-cloud.net/img/staff_img/" + profile.staff_photo2;
      // 削除ボタン表示
    ...
    if (
      typeof profile.staff_photo3 !== "undefined" &&
      profile.staff_photo3 != null &&
      profile.staff_photo3 != ""
    ) {
      var photo_3 =
        "https://www.total-cloud.net/img/staff_img/" + profile.staff_photo3;
      // 削除ボタン表示
    ...
    if (
      typeof profile.staff_photo4 !== "undefined" &&
      profile.staff_photo4 != null &&
      profile.staff_photo4 != ""
    ) {
      var photo_4 =
        "https://www.total-cloud.net/img/staff_img/" + profile.staff_photo4;
      // 削除ボタン表示
      //setphotoDisplay3(false);
  ...
  const [profile_tag, setprofile_tag] = useState({
    tags: { tag: "", tagsArray: buf_profile_tag },
  });
  ...
  ****************************************************************/
  ...
  function onSubmit() {
    ...
    // ※「空白系 全角「、」を「,」に変換」
    save_profile_tag = "";
    save_profile_tag = replaceElement(
      profile_tag["tags"]["tagsArray"],
      ",",
      "、"
    );
            ...
            .then((json) => {
              ...
              db.transaction((tx) => {
                tx.executeSql(
                  "update staff_mst set " +
                    mail_select +
                    " = null where (account = ? and password = ?);",
          ...
          >
            ...
            <View>
              <RadioButtonRN
                ...
                activeColor={"#191970"}
                initial={
                  !contact ? 1 : contact === "9_1" ? 2 : contact === "9" ? 3 : 2
                }
              />
            </View>
            ...
            <View style={[styles.setting2]}>
              <View style={{ width: "70%", alignSelf: "center" }}>
                <Text style={styles.dropDownlabel}>
                  5.担当するお客様が設定リンク先を閲覧した時に、個人携帯に通知
                </Text>
              </View>
              <RadioButtonRN
                data={DoNotDo}
            ...
            <View style={[styles.setting2]}>
              <View style={{ width: "70%", alignSelf: "center" }}>
                ...
                <TextInput
                  value={
                    setting_list7_mail === "null" ? "" : setting_list7_mail
                  }
                  onChangeText={(text) => {
                    setSetting_list7_mail(text);
                  }}
            ...
            <View style={{ flexDirection: "row", alignSelf: "center" }}>
              <View style={{ width: "48%" }}>
                ...
                <Image
                  ...
                  resizeMode="contain"
                  source={{
                    uri: filedata1 ? filedata1.uri + "?" + nowDate : null,
                  }}
                />
                <TouchableOpacity
                  onPress={() => pickImage("1")}
                ...
                <TouchableOpacity
                  onPress={() => delImage("1")}
                  style={photoDisplay1 ? styles.hide_view : styles.photoDel}
                >
              ...
              <View style={{ width: "48%", marginLeft: 10 }}>
                ...
                <TouchableOpacity
                  onPress={() => delImage("4")}
                  style={photoDisplay4 ? styles.hide_view : styles.photoDel}
                >
                  <Text style={styles.photoDelImg}>写真削除</Text>
                </TouchableOpacity>
              </View>
            ...
            >
              <View style={{ width: "45%" }}>
                ...
                <TouchableOpacity
                  onPress={() => delImage("2")}
                  style={photoDisplay2 ? styles.hide_view : styles.photoDel}
                >
                  <Text style={styles.photoDelImg}>写真削除</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={{ width: "48%", marginLeft: 10 }}>
                ...
                <TouchableOpacity
                  onPress={() => delImage("3")}
                  style={photoDisplay3 ? styles.hide_view : styles.photoDel}
                >
                  <Text style={styles.photoDelImg}>写真削除</Text>
                </TouchableOpacity>
              </View>
            ...
            <View style={{ flexDirection: "row" }}>
              <TextInput
                ...
                onChangeText={(text) => {
                  setstaff_birthday_year(
                    isNaN(text) ? staff_birthday_year : text
                  );
                }}
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  setstaff_birthday_month(text);
                }}
                style={styles.inputInnerbirthday}
                editable={true}
                keyboardType={"number-pad"}
                onChangeText={(text) => {
                  setstaff_birthday_month(
                    isNaN(text) ? staff_birthday_month : text
                  );
                }}
              />
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  setstaff_birthday_day(
                    isNaN(text) ? staff_birthday_day : text
                  );
                }}
                keyboardType={"number-pad"}
                style={styles.inputInnerbirthday}
            ...
            <Text onPress={() => desplayTag("")} style={styles.labeltag}>
              人気のタグ
            </Text>
            <View
              className="tag_all"
              style={tagDisplay ? styles.hide_view : {}}
            >
              ...
              <View className="tag_fudosan">
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("宅建取引士")}
                    style={styles.labeltag}
                  >
                    宅建取引士
                  </Text>
                  <Text
                    onPress={() => setTagData("不動産歴10年以上")}
                    style={styles.labeltag}
                  >
                    不動産歴10年以上
                  </Text>
                  <Text
                    onPress={() => setTagData("物件知識豊富")}
                    style={styles.labeltag}
                  >
                    物件知識豊富
                  </Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("運転得意")}
                    style={styles.labeltag}
                  >
                    運転得意
                  </Text>
                  <Text
                    onPress={() => setTagData("マンション管理士")}
                    style={styles.labeltag}
                  >
                    マンション管理士
                  </Text>
                  <Text
                    onPress={() => setTagData("売買")}
                    style={styles.labeltag}
                  >
                    売買
                  </Text>
                  <Text
                    onPress={() => setTagData("テナント")}
                    style={styles.labeltag}
                  >
                    テナント
                  </Text>
              ...
              <Text className="tag_all" style={styles.tagTitle}>
                〇スポーツ
              </Text>
              <View className="tag_sports">
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("ゴルフ")}
                    style={styles.labeltag}
                  >
                    ゴルフ
                  </Text>
                  <Text
                    onPress={() => setTagData("サッカー")}
                    style={styles.labeltag}
                  >
                    サッカー
                  </Text>
                  <Text
                    onPress={() => setTagData("野球")}
                    style={styles.labeltag}
                  >
                    野球
                  </Text>
                  <Text
                    onPress={() => setTagData("バスケット")}
                    style={styles.labeltag}
                  >
                    バスケット
                  </Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("ダンス")}
                    style={styles.labeltag}
                  >
                    ダンス
                  </Text>
                  <Text
                    onPress={() => setTagData("スポーツ観戦")}
                    style={styles.labeltag}
                  >
                    スポーツ観戦
                  </Text>
              ...
              <View className="tag_hobby">
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("美味しいお店")}
                    style={styles.labeltag}
                  >
                    美味しいお店
                  </Text>
                  <Text
                    onPress={() => setTagData("美味しいお酒")}
                    style={styles.labeltag}
                  >
                    美味しいお酒
                  </Text>
                  <Text
                    onPress={() => setTagData("写真")}
                    style={styles.labeltag}
                  >
                    写真
                  </Text>
                  <Text
                    onPress={() => setTagData("音楽")}
                    style={styles.labeltag}
                  >
                    音楽
                  </Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("ジャズ")}
                    style={styles.labeltag}
                  >
                    ジャズ
                  </Text>
                  <Text
                    onPress={() => setTagData("演奏")}
                    style={styles.labeltag}
                  >
                    演奏
                  </Text>
                  <Text
                    onPress={() => setTagData("ピアノ")}
                    style={styles.labeltag}
                  >
                    ピアノ
                  </Text>
                  <Text
                    onPress={() => setTagData("ギター")}
                    style={styles.labeltag}
                  >
                    ギター
                  </Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("コレクション")}
                    style={styles.labeltag}
                  >
                    コレクション
                  </Text>
                  <Text
                    onPress={() => setTagData("ワイン")}
                    style={styles.labeltag}
                  >
                    ワイン
                  </Text>
                  <Text
                    onPress={() => setTagData("ビール")}
                    style={styles.labeltag}
                  >
                    ビール
                  </Text>
                  <Text
                    onPress={() => setTagData("焼酎")}
                    style={styles.labeltag}
                  >
                    焼酎
                  </Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("カクテル")}
                    style={styles.labeltag}
                  >
                    カクテル
                  </Text>
                  <Text
                    onPress={() => setTagData("サウナ")}
                    style={styles.labeltag}
                  >
                    サウナ
                  </Text>
                  <Text
                    onPress={() => setTagData("アニメ")}
                    style={styles.labeltag}
                  >
                    アニメ
                  </Text>
              ...
              <View className="tag_personality">
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("明るい")}
                    style={styles.labeltag}
                  >
                    明るい
                  </Text>
                  <Text
                    onPress={() => setTagData("真面目")}
                    style={styles.labeltag}
                  >
                    真面目
                  </Text>
                  <Text
                    onPress={() => setTagData("会話が好き")}
                    style={styles.labeltag}
                  >
                    会話が好き
                  </Text>
                  <Text
                    onPress={() => setTagData("コツコツ")}
                    style={styles.labeltag}
                  >
                    コツコツ
                  </Text>
              ...
              <View className="tag_area">
                <View style={{ flexDirection: "row" }}>
                  <Text>　</Text>
                  <Text
                    onPress={() => setTagData("大阪市")}
                    style={styles.labeltag}
                  >
                    大阪市
                  </Text>
                  <Text
                    onPress={() => setTagData("堺市")}
                    style={styles.labeltag}
                  >
                    堺市
                  </Text>
                  <Text
                    onPress={() => setTagData("豊中市")}
                    style={styles.labeltag}
                  >
                    豊中市
                  </Text>
                  <Text
                    onPress={() => setTagData("吹田市")}
                    style={styles.labeltag}
                  >
                    吹田市
                  </Text>
                  <Text
                    onPress={() => setTagData("京都市")}
                    style={styles.labeltag}
                  >
                    京都市
                  </Text>
