    ...
    if (inquiry) {
      ...
      var inquiry_data = inquiry.map((i) => {
        const i_data =
          ...
          i.station_name1 +
          " " +
          (i.station_how_to1 == "徒歩"
            ? i.station_how_to1 + i.station_time1
            : i.station_how_to1 == "バス"
            ? i.station_how_to1 + i.bus_time1
            : "") +
          "分\n" +
          "賃料：" +
          i.rent / 10000 +
      ...
      .map((com) => {
        ...
        if (com.speaker === "お客様") {
          const data = {
            ...
            text:
              com.note +
              (com.line_note && com.title !== "スタンプ" ? com.line_note : ""),
            image: com.file_path
              ? com.file_path
              : com.title === "スタンプ"
    ...
    return (
      <Bubble
        ...
        wrapperStyle={{
          ...
          left: {
            backgroundColor:
              stamp === "スタンプ" || image !== "" ? "transparent" : "#346cb8",
            marginLeft: 5,
            marginVertical: 5,
            ...
            db.transaction((tx) => {
              communication.map((c) => {
                rocal.map((r) => {
                  if (c.del_flg) {
                    if (
                      c.communication_id === r.communication_id &&
              ...
              const add_communication_list = server_communication_list.filter(
                (c) => local_communication_list.indexOf(c) == -1
              );
    ...
    <>
      ...
      <GiftedChat
          ...
          return (
            ...
            <Actions
              ...
              icon={() => (
                <Feather
                  name={"menu"}
                  color={!global.fc_flg ? "#191970" : "#ffffff"}
                  size={25}
                />
              )}
            />
        ...
        renderAccessory={(props) => (
          <View style={[styles.border, !menu ? { display: "none" } : ""]}>
            <View style={[styles.menu, { marginTop: 15 }]}>
              <TouchableOpacity
                style={!customer.line ? { display: "none" } : styles.menuBox}
                onPress={() => menuPress(1)}
              >
              ...
              <TouchableOpacity
                style={
                  customer.line && video_option
                    ? styles.menuBox
                    : { display: "none" }
                }
                onPress={() => online_call(route.customer)}
              >
