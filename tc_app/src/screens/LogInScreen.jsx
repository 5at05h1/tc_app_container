    ...
    if (rocalDB.length != 0) {
      ...
      fetch(domain + "batch_app/api_system_app.php?" + Date.now(), {
        ...
        .then((json) => {
          ...
          // // websocket通信
          const WS_URL =
            "ws://54.168.20.149:8080/ws/" + json.staff.shop_id + "/";
        ...
        <View style={styles.input}>
          <FloatingLabelInput
            ...
            customShowPasswordComponent={
              <Feather name="eye" size={20} color="#1f2d53" />
            }
            customHidePasswordComponent={
              <Feather name="eye-off" size={20} color="#1f2d53" />
            }
            onChangeText={(text) => {
              setPassword(text);
            }}
          ...
          <>
            ...
            >
              <Image
                source={require("../../assets/logo_onetop.png")}
                resizeMode="cover"
                style={styles.onetop_btn}
              />
            </TouchableOpacity>
          </>
        ) : (
          <>
            <Text style={[styles.onetop, { color: "#1d449a" }]}>
              TOTAL CLOUD はこちらから
            </Text>
            <TouchableOpacity
              style={styles.buttonContainer}
